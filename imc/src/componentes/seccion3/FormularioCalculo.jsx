...
class FormularioCalculo extends React.Component {
  ...
  constructor(props) {
      super(props);
      // esto se hace para que el this que esta dentro de calcularIMC 
      // no se pierda si no que haga referencia al this de la clase
      // del componente FormularioCalculo
  ...
  calcularIMC(e) {
    try {
        ...
        if(!isNaN(imc)){
          // este This.C_IMC es el que esta llegando por prpos de IMC.jsx
          // aca se donde se modifica el estado
